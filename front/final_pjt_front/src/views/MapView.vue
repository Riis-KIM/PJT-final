<template>
  <div class="container mt-5">
    <h1 class="fw-bold mb-4">🏦 은행 위치 검색</h1>

    <!-- 필터 선택 -->
    <div class="row mb-3">
      <div class="col-md-3">
        <label for="province" class="form-label">광역시/도</label>
        <select id="province" class="form-select" v-model="selectedProvince" @change="fetchCities">
      ...
      <div class="col-md-3">
        ...
        <select id="city" class="form-select" v-model="selectedCity" :disabled="!cities.length">
      ...
      <div class="col-md-3">
        ...
        <select id="bank" class="form-select" v-model="selectedBank">
      ...
      <div class="col-md-3">
        <label for="radius" class="form-label">검색 반경</label>
        <select id="radius" class="form-select" v-model="searchRadius">
    ...
    <div class="text-center">
      ...
      <button @click="resetFilters" class="btn btn-secondary ms-2">초기화</button>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      cities: [],
      banks: ["국민은행", "우리은행", "신한은행", "하나은행", "농협은행"],
      selectedProvince: "",
      selectedCity: "",
      selectedBank: "",
      searchRadius: "1000",
  ...
  methods: {
    ...
    fetchCities() {
      const cityData = {
        ...
        세종특별자치시: ["세종특별자치시"],
        경기도: [
          "수원시", "고양시", "용인시", "성남시", "부천시", "안산시", "안양시", "남양주시", "화성시",
          "평택시", "의정부시", "파주시", "시흥시", "김포시", "광주시", "광명시", "군포시", "오산시",
          "이천시", "안성시", "의왕시", "양주시", "구리시", "포천시", "하남시", "여주시", "양평군", "가평군", "연천군"
        ],
        강원도: [
